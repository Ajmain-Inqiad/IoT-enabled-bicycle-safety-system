...
void uploadGPS() {
  ...
  if (sendCommand("AT+GPSRD", "OK", 10000, 0, ans)) {
    ...
    if ((latt.toInt() != 0) && (lont.toInt() != 0)) {      
      ...
      A7board.println("GET /update?api_key=DYHXEIQHNADFA68L&field1=" + latt + "&field2=" + lont + "&field3=10");
      delay(5000);
      print_result();
    }
  }
...
void SendTextMessage() {
  ...
  if ((latt.toInt() != 0) && (lont.toInt() != 0)) {
    ...
    String msg = "In danger. http://maps.google.com/maps?f=q&q="+String(lattval)+","+String(lontval)+"&z=16";
...
//    Serial.print(replace4VIEW(expAnsw));
//    Serial.println(")");
    stat = true;
  } else {
    Serial.print("ERROR: ");
